...
function App() {
  return (
    <div>
      <header>
        <nav className="navbar navbar-expand-lg shadow-sm py-2 bg-amber-200 relative flex items-center w-full justify-between">
          <div className="px-6 w-full flex flex-wrap items-center justify-between">
            <div className="flex items-center">
              <a className="text-black font-bold no-underline">Patti's Paintings</a>
              <button
